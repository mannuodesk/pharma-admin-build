...
var AddMedicineComponent = (function () {
    ...
    AddMedicineComponent.prototype.addMedicine = function () {
        ...
        if (this.runner == false) {
            ...
            if (__WEBPACK_IMPORTED_MODULE_8__models_validation_class__["a" /* ValidationModel */].validateString(this.ManufacturerName)) {
                this.runner = false;
                $('#loader').hide();
            ...
            this._addMedicineService.addMedicine(this.MedicineName, this.ManufacturerName, measurement_ids, variation_dto_array, this.SubCategoryId, this.PharmacistId, this.ImageUrl).subscribe(function (response) {
                $('#loader').hide();
                _this.runner = false;
                _this.MedicineName = "";
